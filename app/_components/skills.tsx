      ...
      <div className={`content leaning`}>
        ...
        <div className={styles.skills_content}>
          <div className={`${styles.box}`}>
            {!isMobile ? (
              <WideScreenView data={rawData} />
            ) : (
              <NarrowScreenView data={rawData} />
            )}
          </div>
        </div>
      </div>
      ...
      <div className={`${styles.menu}`}>
        {data.map((category, index) => (
          <SkillCategoryView
            ...
            onClick={() =>
              setSelectedCategory(category.translations[locale].name)
            }
            selectioned={
              selectedCategory === category.translations[locale].name
            }
          />
        ))}
      </div>
