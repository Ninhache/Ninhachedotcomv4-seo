      ...
      >
        <div className={`${styles.project_text}`}>
          ...
          {project.links.redirect === 'none' ? (
            <span className={`${styles.title} ${calibreSemibold.className}`}>{project.title}</span>
          ) : (
            <Link
          ...
          <div className={`${styles.links}`}>
            {project.links.git !== 'none' && (
              <Link className={`${styles.github}`} href={`${project.links.git}`} target="_blank">
                ...
                <span className={`${styles.bubble} ${ralewayBold.className}`}>{t('openGit')}</span>
              </Link>
            )}
            {project.links.play !== 'none' && (
              <Link className={`${styles.test}`} href={`${project.links.play}`} target="_blank">
                ...
                <span className={`${styles.bubble} ${ralewayBold.className}`}>{t('runCode')}</span>
              </Link>
            )}
          </div>
        </div>
