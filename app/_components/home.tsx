      ...
      <section id={t('anchor')} className={`section ${styles.home_section}`}>
        ...
        <div className={`content ${styles.content}`}>
          <AnimatedComponent delay={100}>
            <span className={`${styles.hi} ${ralewaySemiBold.className}`}>{t('greeting')}</span>
          </AnimatedComponent>
          <AnimatedComponent delay={200} customCss={{ marginTop: 25 }}>
            <span className={`${styles.name} ${calibreSemibold.className}`}>{t('name')}</span>
          </AnimatedComponent>
          ...
          <AnimatedComponent delay={400}>
            <p className={`${styles.bio} ${calibreRegular.className}`}>{t('description')}</p>
          </AnimatedComponent>
